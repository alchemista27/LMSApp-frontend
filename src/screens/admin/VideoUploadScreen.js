// src/screens/admin/VideoUploadScreen.js
...
import { ChevronLeftIcon, VideoCameraIcon, CloudUploadIcon, CheckCircleIcon } from 'react-native-heroicons/outline';
  ...
  const FileInfo = ({ file }) => (
    <View className="bg-green-50 rounded-xl p-4 mb-4">
      <View className="flex-row items-center">
        <VideoCameraIcon size={24} color="#10b981" />
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-white px-6 pt-12 pb-4 shadow-sm">
        <View className="flex-row items-center mb-4">
          ...
          <View>
            <Text className="text-2xl font-bold text-gray-800">Upload Video</Text>
      ...
      >
        <View className="px-6 pt-6">
          ...
          <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
            <Text className="text-lg font-bold text-gray-800 mb-2">Upload Video File</Text>
            <Text className="text-gray-600 mb-6">
              Select a video file from your device to upload. Supported formats: MP4, MOV, AVI
            </Text>
            ...
            <View className="mt-6 p-4 bg-blue-50 rounded-xl">
              <Text className="text-primary-700 font-semibold mb-2">Video Upload Guidelines:</Text>
              <Text className="text-primary-600 text-sm">• Supported formats: MP4, MOV, AVI</Text>
              <Text className="text-primary-600 text-sm">• Maximum file size: 500MB</Text>
              <Text className="text-primary-600 text-sm">• Recommended resolution: 1080p or 720p</Text>
              <Text className="text-primary-600 text-sm">• Ensure good audio quality</Text>
              <Text className="text-primary-600 text-sm">• Keep videos under 2 hours for best performance</Text>
            </View>
          </View>
        </View>
      </ScrollView>
